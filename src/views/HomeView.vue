<template>
  <div>
    ...
    <v-container>
      <v-row>
        <v-col cols="10">
          <h1 style="text-align: center;">نظام قرارات شؤون مجلس الوزراء</h1>
                    ...
                    <div>
                      <div class="card-image">
                        <a href="https://cabinet.iq/ar">
                          ...
                          <img class="slider--image" src="@/assets/logo3.png" alt="winter-01" />
                        </a>
                      </div>
                    </div>
                  </div>
                    ...
                    <div>
                      <div class="card-image">
                        <a href="https://ur.gov.iq/">
                          ...
                          <img class="slider--image" src="@/assets/img333.png" alt="winter-01" />
                        </a>
                      </div>
                    </div>
                  </div>
...
.slider--heading {
  ...
  text-align: center;
  background-color: rgba(9, 245, 76, 0.5);
  color: rgba(30, 232, 100, 0.5);
  transform: translate3d(-30%, -30%, 0);
}
.slider--heading h1 {
  font: 300 1.25rem/1.25 Verdana, sans-serif;
  text-transform: uppercase;
  color: rgba(9, 234, 80, 0.5);
}
